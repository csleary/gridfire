...
const streamFromBucket = async (bucketName, objectKey, readableStream) => {
  const getObjectCommand = new GetObjectCommand({ Bucket: bucketName, Key: objectKey, Body: readableStream });
