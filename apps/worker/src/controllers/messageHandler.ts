import { BlockMessage, JobMessage, MessageHandler } from "@gridfire/shared/types/amqp";
...
const isJobMessage = (message: BlockMessage | JobMessage): message is JobMessage => "job" in message;
const jobs: Record<string, (message: JobMessage) => Promise<void>> = { encodeFLAC, transcodeAAC, transcodeMP3 };

const messageHandler: MessageHandler = async (message: BlockMessage | JobMessage) => {
