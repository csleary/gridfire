...
describe("Lock", function () {
  ...
  async function deployOneYearLockFixture() {
    ...
    return { lock, lockedAmount, otherAccount, owner, unlockTime };
  }
  ...
  describe("Withdrawals", function () {
    ...
    describe("Events", function () {
      it("Should emit an event on withdrawals", async function () {
        const { lock, lockedAmount, unlockTime } = await loadFixture(deployOneYearLockFixture);
        await time.increaseTo(unlockTime);
    ...
    describe("Transfers", function () {
      it("Should transfer the funds to the owner", async function () {
        const { lock, lockedAmount, owner, unlockTime } = await loadFixture(deployOneYearLockFixture);
        await time.increaseTo(unlockTime);
